...
local time = require("neopilot.time")
local MAX_REQUEST_DEFAULT = 5

--- @type table<number, _neopilot.Logger.RequestLogs>
local logger_cache = {}
local logger_list = {}
local max_requests_in_logger_cache = MAX_REQUEST_DEFAULT

--- @class _neopilot.Logger.Options
--- @field level number?
...
--- @class _neopilot.Logger.RequestLogs
--- @field last_access number
--- @field logs string[]

--- @class _neopilot.Logger
--- @field level number
...
--- @param opts _neopilot.Logger.Options?
