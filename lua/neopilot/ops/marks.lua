...
local nsid = vim.api.nvim_create_namespace("neopilot.marks")

--- @class _neopilot.Mark.Text
--- @field text string
--- @field hlgroup string

--- @class _neopilot.Mark
...
--- @param buffer number
--- @param func _neopilot.treesitter.Function
--- @return _neopilot.Mark
