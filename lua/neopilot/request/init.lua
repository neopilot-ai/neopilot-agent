--- @alias _neopilot.Request.State "ready" | "calling-model" | "parsing-result" | "updating-file" | "cancelled"
--- @alias _neopilot.Request.ResponseState "failed" | "success" | "cancelled"

--- @class _neopilot.ProviderObserver
--- @field on_stdout fun(line: string): nil
--- @field on_stderr fun(line: string): nil
--- @field on_complete fun(status: _neopilot.Request.ResponseState, res: string): nil

--- @class _neopilot.Provider
--- @field make_request fun(self: _neopilot.Provider, query: string, request: _neopilot.Request, observer: _neopilot.ProviderObserver)
...
--- @param query string
---@param self _neopilot.Provider
---@param query string
---@param request _neopilot.Request
---@param observer _neopilot.ProviderObserver?
function OpenCodeProvider.make_request(_, query, request, observer)
  ...
  --- @param status _neopilot.Request.ResponseState
  ---@param text string
...
--- @class _neopilot.Request.Opts
--- @field model string
--- @field tmp_file string
--- @field provider _neopilot.Provider?
--- @field xid number

--- @class _neopilot.Request.Config
--- @field model string
--- @field tmp_file string
--- @field provider _neopilot.Provider
--- @field xid number

--- @class _neopilot.Request
--- @field context _neopilot.RequestContext
--- @field state _neopilot.Request.State
--- @field provider _neopilot.Provider
--- @field logger _neopilot.Logger
...
--- @return _neopilot.Request
function Request.new(context)
  local provider = context._neopilot.provider_override or OpenCodeProvider
  return setmetatable({
    context = context,
    provider = provider,
    state = "ready",
