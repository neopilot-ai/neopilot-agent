...
--- @class _neopilot.test.ProviderRequest
--- @field query string
--- @field request _neopilot.Request
--- @field observer _neopilot.ProviderObserver?
--- @field logger _neopilot.Logger

--- @class _neopilot.test.Provider : _neopilot.Provider
--- @field request _neopilot.test.ProviderRequest?
local TestProvider = {}
