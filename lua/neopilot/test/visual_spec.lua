...
--- @return _neopilot.test.Provider, number, _neopilot.Range
...
describe("visual", function()
  it("should replace visual selection with AI response", function()
    ...
    local visual_fn = require("neopilot.ops.over-range")

    local context =
      require("neopilot.request-context").from_current_buffer(state, 100)
  ...
  it("should handle multi-line replacement", function()
    ...
    local context =
      require("neopilot.request-context").from_current_buffer(state, 200)
    visual_fn(context, range)
  ...
  it("should cancel request when stop_all_requests is called", function()
    ...
    local state = _neopilot.__get_state()
    local context =
      require("neopilot.request-context").from_current_buffer(state, 300)
  ...
  it("should handle error cases with graceful failures", function()
    ...
    local state = _neopilot.__get_state()
    local context =
      require("neopilot.request-context").from_current_buffer(state, 400)
  ...
  it("should handle cancelled status gracefully", function()
    ...
    local state = _neopilot.__get_state()
    local context =
      require("neopilot.request-context").from_current_buffer(state, 500)
